...
import { Edit, Home, LogOut, Order, Store, Truck } from '@/utils/iconData';
            ...
            <div className="grid grid-cols-5 min-h-screen w-screen">
                <div className="col-span-1 bg-zinc-100">
                    ...
                    <div className="px-8 mt-8 text-sm">
                        ...
                        <Link href={'/dashboard/orders'} className="flex dashboard-head">
                            <Order />
                            <h1 className="ml-3 mt-0.5 font-medium">ORDERS</h1>
                        </Link>
                        <Link href={'/dashboard/delivery'} className="flex dashboard-head">
                            <Truck />
                            <h1 className="ml-3 mt-0.5 font-medium">DELIVERY</h1>
                        </Link>
